...
writeFastq(R1,file="test_data/Sample_ID_001_R1.fastq.gz")
writeFastq(R2,file="test_data/Sample_ID_001_R2.fastq.gz")
```
...
```{r}
files <- tibble(files = dir("test_data", full.names = T, recursive = T, pattern = "*.gz")) %>%
