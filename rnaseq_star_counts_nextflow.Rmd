...
Next include `STAR_ALIGN`  in the same format as `FASTQC` to the nextflow `main.nf` file. 
...
profiles {
    ...
    PBS_singularity {
        ...
        //process.clusterOptions = "-P \$(voucher project ${params.project})" //renders correctly in command.run script but schedule won't accept it.
