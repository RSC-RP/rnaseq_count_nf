...
set.seed(123); R1 <- ShortRead::yield(sampler)
sampler <- ShortRead::FastqSampler("test_data/Day0.Naive_L1Pf7_R2.fastq.gz", 10000)
set.seed(123); R2 <- ShortRead::yield(sampler)
...
# Define the configurations for FASTQC
...
The final desired parameters will be: 
...
However, running locally with 32Gb of memory, even with the subset fastqs, is running out of memory.
