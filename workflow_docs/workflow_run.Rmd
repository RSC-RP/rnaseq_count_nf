...
First, grab a compute node and activate the conda enviroment. 
...
Determine if the workflow works on your installation of the conda environment by running the following commands. 


```{bahs}
./main_run "paired_end_test"
```
